...
| ---- | -------- | --------------------------------------- | ------------------------------ |
| 1    | idea     | `GameStateManager` + `InputManager` | Phase 2 (Hour 6–14)           |
| 2    | Te       | Core mechanic `Update()` logic        | Phase 2–3 (Hour 6–24)        |
| 3    | name     | Render/`SpriteBatch` + Collision      | Phase 2–3 (Hour 6–24)        |
| 4    | Atom     | Content pipeline (MGCB) + Audio/UI      | Phase 3–4 (Hour 14–34)       |
